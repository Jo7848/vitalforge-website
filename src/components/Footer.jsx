  ...
  return (
    <footer style={{
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div className="footer-links" style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', marginBottom: '1rem' }}>
        ...
        <div className="footer-socials" style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
